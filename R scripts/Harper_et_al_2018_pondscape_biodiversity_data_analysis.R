...
p5 <- p5 + scale_fill_manual(name="Great crested newt",
                             values=c("grey45","orange"),
                             breaks=c("0","1"),
                             labels=c("Negative",
                                      "Positive"))
...
p1m <- p1m + labs(y="Probability of great crested newt", x = "Number of other amphibian species") 
...
p2m <- p2m + labs(y="Probability of great crested newt", x = "Number of fish species") 
...
p4m <- p4m + labs(y="Probability of great crested newt", x = "Number of terrestrial bird species") 
...
p5m <- p5m + labs(y="Probability of great crested newt", x = "Number of mammal species") 
...
GCNdist < scale(GCNdist[,c(2:6,25)])
...
p12 <- p12 + labs(x = "Smooth newt",
                  y = "Probability of great crested newt") 
...
p15 <- p15 + scale_x_discrete(breaks=c("0", "1"),
                              labels=c("Absent", "Present"))
p15 <- p15 + labs(x = "Grey squirrel", y = "")
...
p16 <- p16 + geom_jitter(aes(x=Outflow, y=Triturus_cristatus, colour=Triturus_cristatus), width=0.3, height=0.3, cex=1)
...
p22 <- p22 + scale_colour_gradient(name="Great crested newt\n occupancy\n",
                                   low="grey45", high="orange")
...
grid.arrange(p23,p24,p25,p26,p27,p28,p29, nrow=4, ncol=2)
